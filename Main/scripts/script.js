const openEyes = document.querySelectorAll("img[src='../main/images/open_eye.svg']");
const irises = document.querySelectorAll("a img[src^='../main/images/iris']");
const iris5 = document.querySelector("a img[src='../main/images/iris5.svg']");
const iris8 = document.querySelector("a img[src='../main/images/iris8.svg']");
...
iris5.addEventListener("click", () => {
  ...
  const openEyeSrc = "../main/images/open_eye.svg";
  const closedEyeSrc = "../main/images/closed_eye.svg";
...
iris8.addEventListener("click", () => {
  ...
  setTimeout(() => {
    ...
    if (iris8.src.endsWith("iris8.svg")) {
      iris8.src = "../main/images/downloaded.svg";
      // Download the CV file
      const downloadLink = document.createElement("a");
      downloadLink.href = "../main/images/cv.pdf";
      downloadLink.download = "cv.pdf";
      downloadLink.click();
    } else {
      iris8.src = "../main/images/iris8.svg";
    }
  }, blinkDuration);
});
  ...
  eye.addEventListener("click", () => {
    ...
    setTimeout(() => {
      ...
      if (iris.src.endsWith("iris.svg")) {
        iris.src = "../main/images/email.svg";
        // Copy the email address to the user's clipboard
        const email = "olgweygang@gmail.com";
        navigator.clipboard.writeText(email);
      } else {
        iris.src = "../main/images/iris.svg";
      }
    }, blinkDuration);
  });
});
    ...
    .filter(
      (eye) =>
        !eye.previousElementSibling.querySelector(
          "img[src='../main/images/iris5.svg'], img[src='../main/images/email.svg'], img[src='../main/images/iris8.svg'], img[src='../main/images/downloaded.svg']"
        )
    )
